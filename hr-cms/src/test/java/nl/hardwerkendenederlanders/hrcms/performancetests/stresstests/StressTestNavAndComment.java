...
public class StressTestNavAndComment extends Simulation {

  private HttpProtocolBuilder httpProtocol = http
    .baseUrl("http://localhost:" + performanceTestServerPort)
  ...
  private ScenarioBuilder scn = scenario("login")
    .exec(
      ...
      http("post login information")
        ...
        .check(status().is(404)), // for some reason logging in on gatling sends you to 404 page. probs sends you to http://localhost:6031/jsession<somethingelsehere>
      pause(3),
      http("get random page of articles")
        .get("/?page=2")
        .headers(headers_2),
      pause(3),
      ...
      http("post comment at article")
        .post("/comment/article/00000000-0000-0000-0000-001900110018/new")
        .headers(headers_5)
