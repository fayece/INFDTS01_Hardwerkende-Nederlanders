...
public class databaseSeeder {
    ...
    private UUID createNumericUUID(int number){
        return UUID.fromString(String.format("%32s", number).replace(' ', '0').replaceFirst("(\\p{XDigit}{8})(\\p{XDigit}{4})(\\p{XDigit}{4})(\\p{XDigit}{4})(\\p{XDigit}{8})", "$1-$2-$3-$4-$5"));
    }
    ...
    public void seed2() {
        ...
        var firstNames = Arrays.asList(
                "Berend", "Henk", "Frits", "Albert",
                "Joost", "Ben", "Sjaak", "Willem",
                "Roderik", "Stein", "Johan", "Annabell",
                "Emma", "Guusje", "Annemarie", "Maria",
                "Jan", "Piet", "Kees", "Dirk",
                "Arie", "Bram", "Cornelis", "Klaas",
                "Harm", "Gerrit", "Teun", "Leendert",
                "Hendrik", "Bastiaan", "Martinus", "Pieter",
                "Rutger", "Douwe", "Wouter", "Barend",
                "Huib", "Tjerk", "Siebe", "Koos",
                "Aart", "Floris", "Niek", "Maarten",
                "Joris", "Thijs", "Adriaan", "Boudewijn",
                "Evert", "Rik", "Tobias", "Roelof",
                "Sybren", "Wiebe", "Gerben", "Arend",
                "Jacobus", "Nicolaas", "Lambert", "Wim",
                "Theo", "Karel", "Anton", "Frans",
                "Geertruida", "Grietje", "Jannetje", "Trijntje",
                "Aaltje", "Neeltje", "Antje", "Maaike",
                "Marijke", "Liesbeth", "Femke", "Renske",
                "Sanne", "Tessa", "Hilde", "Bregje",
                "Willemijn", "Aleida", "Cornelia", "Johanna",
                "Catharina", "Petronella", "Henriette", "Elsje",
                "Doortje", "Miep", "Jet", "Fenna",
                "Nienke", "Anouk", "Lotte", "Hanneke",
                "Joke", "Anniek", "Suzanna", "Rika",
                "Wilhelmina", "Alida", "Bep", "Tiny",
                "Tineke", "Saskia", "Baukje", "Jitske"
        );


        var words = Arrays.asList(
                "the ", "but ", "so ", "very good idea ",
                "new ", "created ", "he ", "she ",
                "they ", "viewers ", "audience ",
                "exploded ", "amazing ", "find ",
                "I ", "bad idea ", "hopeless ", ".",

                // Common English words
                "a ", "an ", "and ", "or ", "if ", "then ",
                "because ", "when ", "where ", "what ", "why ",
                "who ", "how ", "this ", "that ", "these ", "those ",
                "is ", "was ", "are ", "were ", "be ", "been ",
                "have ", "has ", "had ", "do ", "does ", "did ",
                "can ", "could ", "will ", "would ", "should ",
                "to ", "from ", "with ", "without ", "for ", "about ",
                "into ", "over ", "under ", "before ", "after ",
                "people ", "friends ", "family ", "story ",
                "world ", "music ", "sound ", "voice ",
                "night ", "day ", "life ", "dream ",
                "love ", "heart ", "mind ", "feeling ",
                "beautiful ", "perfect ", "crazy ", "wild ",
                "happy ", "sad ", "strong ", "alone ",
                "everything ", "nothing ", "something ", "anything ",
                "always ", "never ", "sometimes ", "again ",
                "today ", "tomorrow ", "yesterday ",
                "big ", "small ", "fast ", "slow ",
                "good ", "great ", "best ", "worst ",

                // Pop music themed
                "song ", "songs ", "album ", "albums ",
                "track ", "tracks ", "single ", "hit ",
                "chart ", "billboard ", "radio ", "stream ",
                "streaming ", "viral ", "trending ",
                "concert ", "tour ", "festival ", "show ",
                "stage ", "performance ", "dance ",
                "beat ", "rhythm ", "melody ", "chorus ",
                "verse ", "hook ", "bridge ", "drop ",
                "lyrics ", "singer ", "artist ", "band ",
                "producer ", "studio ", "record ",
                "microphone ", "guitar ", "piano ", "drums ",
                "fans ", "crowd ", "spotlight ",
                "celebrity ", "famous ", "superstar ",
                "party ", "club ", "disco ",
                "romance ", "breakup ", "emotion ",
                "summer hit ", "love song ", "dance floor ",
                "top charts ", "music video ", "world tour ",
                "encore ", "headline ", "backstage ",
                "acoustic ", "remix ", "collab ",
                "synth ", "bass ", "vocals ",
                "autotune ", "playlist ", "anthem ",
                "pop star ", "gold record ", "platinum ",
                "number one ", "fanbase ", "live performance "
        );
        ...
        for (int batchStart = 1; batchStart < totalUsers; batchStart += BATCH_SIZE) {
            ...
            for (int i = batchStart; i < batchEnd; i++) {
                ...
                query.append("('")
                        ...
                        .append(userId).append("@theorg.nl', '")
                        .append(password).append("', '")
                        .append(userRole.getId()).append("', ")
                        .append("true),");
        ...
        for (int batchStart = 0; batchStart < totalManagers; batchStart += BATCH_SIZE) {
            ...
            for (int i = batchStart; i < batchEnd; i++) {
                ...
                query.append("('")
                        .append(managerId).append("', '")
                        .append(firstName).append("', ")
                        .append("null, '")
                        .append(lastName).append("', '")
                        .append(manager_num).append("@theorg.nl', '")
                        .append(password).append("', '")
                        .append(contentManagerRole.getId()).append("', ")
                        .append("true),");
        ...
        for (int batchStart = 0; batchStart < totalArticles; batchStart += BATCH_SIZE) {
            ...
            StringBuilder query = new StringBuilder(
                    "INSERT INTO articles " +
                            "(id, title, text_content, publication_status) VALUES "
            );
        ...
        for (int batchStart = 0; batchStart < totalViews; batchStart += BATCH_SIZE) {
            ...
            StringBuilder query = new StringBuilder(
                    "INSERT INTO article_viewers (article_id, viewer_id) VALUES "
            );
